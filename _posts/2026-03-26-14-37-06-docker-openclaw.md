...
## 最后解除环境变量影响，避免物理机的openclaw被影响

```
unset OPENCLAW_CONFIG_DIR
...
openclaw，把X.Y.Z那一套版本号规范整没了，一般X是可以不兼容，Y是X版本下的新功能，Z是必须更新的漏洞，现在OpenClaw直接 YYYY-MM-DD 作为版本号，你不知道更了会不会爆炸，所以用docker才是最稳的