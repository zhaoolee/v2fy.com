...
![大小写兼容匹配](./2022-05-22-wordpress-side-1653217493000.assets/165433572359625pMz0RA.png)

## 7.添加Input搜索

支持标题搜索, 输入关键词, 即可快速查找包含关键词的标题

![添加Input](./2022-05-22-wordpress-side-1653217493000.assets/1654330538860TFAMCpCN.gif)

## 6. 拉取数据期间显示Loading


![拉取数据期间显示Loading](./2022-05-22-wordpress-side-1653217493000.assets/1654330940461TQz63MSM.png)


## 5. 支持通过油猴(Tampermonkey)插件, 为任意WordPress站生成目录


![为任意WordPress站生成目录](./2022-05-22-wordpress-side-1653217493000.assets/1653216793258HazZ1cis.png)

![油猴脚本](./2022-05-22-wordpress-side-1653217493000.assets/1653216913808RmEsdihH.png)
...
![支持缓存侧边栏数据](./2022-05-22-wordpress-side-1653217493000.assets/1653224410691MkC6H6NX.png)


## 3. 侧边栏内容, 支持根据当前网址加深颜色, 并滚动到侧边栏顶部


![支持根据当前网址加深颜色, 并滚动到侧边栏顶部](./2022-05-22-wordpress-side-1653217493000.assets/1653215891375MZS3nyi1.gif)

## 2. 支持根据屏幕宽度判断显示/隐藏侧边目录(窗口宽度500px及以上显示侧边栏, 500px以下则隐藏侧边栏)

![根据屏幕宽度判断显示/隐藏侧边目录](./2022-05-22-wordpress-side-1653217493000.assets/165321562348453F0jPYi.gif)



## 1. 支持手动隐藏显示侧边栏

![支持手动隐藏显示侧边栏](./2022-05-22-wordpress-side-1653217493000.assets/1653215307666P2S7QnCz.gif)
...
![在页脚插入脚本即可](./2022-05-22-wordpress-side-1653217493000.assets/1653217112598XeEDhSbX.png)
