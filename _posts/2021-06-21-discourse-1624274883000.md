...
expose:
  ...
  - "20443:443" # https
```
![](./2021-06-21-discourse-1624274883000.assets/1624275062853RKs5MjKC.png)
...
![image.png](./2021-06-21-discourse-1624274883000.assets/1624275063063KGHQB2Jx.png)
...
![.docker/config.json](./2021-06-21-discourse-1624274883000.assets/1624275063405bDPpYYJH.png)
...
![](./2021-06-21-discourse-1624274883000.assets/1624275063515A2MPPRbX.png)


运行 `./launcher enter app` 进入容器

![成功进入容器](./2021-06-21-discourse-1624274883000.assets/1624275064145zxmcTYaD.png)

运行discourse 可以看的命令提示

![查看命令提示](./2021-06-21-discourse-1624274883000.assets/1624275064893riKf1FiZ.png)


输入 `discourse backup`, 回车获取备份包

![获取备份包](./2021-06-21-discourse-1624274883000.assets/1624275065085D2zJXYjc.png)
...
![传输成功](./2021-06-21-discourse-1624274883000.assets/1624275065315MTTXcJxt.png)


按 Control+D 退出容器, 回到海外宿主机
![退出容器](./2021-06-21-discourse-1624274883000.assets/1624275065481P7W6fNkK.png)
...
```
![发送成功](./2021-06-21-discourse-1624274883000.assets/16242750656503Y4K15Jc.png)
...
![下载成功](./2021-06-21-discourse-1624274883000.assets/1624275065820RTTENDwt.png)
...
docker ps
```
![查看容器id](./2021-06-21-discourse-1624274883000.assets/16242750664801bEEFrZn.png)
...
```
![恢复数据成功](./2021-06-21-discourse-1624274883000.assets/1624275066728eADpBFKB.png)
...
![完美迁移完成](./2021-06-21-discourse-1624274883000.assets/1624275067184TjMkeAGE.png)
