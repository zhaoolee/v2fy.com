...
![github.com/zhaoolee/ChineseBQB](./2021-05-01-huawei-chinesebqb-1619851616000.assets/1619851690038ZMeD1QzW.jpg)
...
](./2021-05-01-huawei-chinesebqb-1619851616000.assets/1619851690029mrQSam4W.jpg)
...
![搜索表情包，长按表情包图片，发给朋友](./2021-05-01-huawei-chinesebqb-1619851616000.assets/1619851690434N52bQZAN.gif)

## 将表情包图片链接，发到不支持表情包的朋友圈

![将表情包图片链接，发到不支持表情包的朋友圈](./2021-05-01-huawei-chinesebqb-1619851616000.assets/1619851690826N1M0eCBp.gif)
...
![PC端](./2021-05-01-huawei-chinesebqb-1619851616000.assets/1619851691219ZHAQyTG3.png)

![移动端](./2021-05-01-huawei-chinesebqb-1619851616000.assets/1619851691537jTRW4S3k.png)

- 表情包工具支持关键词查询，并通过url参数分享搜索结果页
![分享搜索结果](./2021-05-01-huawei-chinesebqb-1619851616000.assets/1619851691968tsTPfNc2.gif)
...
![导出json文件](./2021-05-01-huawei-chinesebqb-1619851616000.assets/1619851692326kRDBksEJ.png)
...
![自动读取特定格式文件夹内表情包数据，并统计数量](./2021-05-01-huawei-chinesebqb-1619851616000.assets/16198516927457PrynTD4.png)

文件夹内表情包数据


![按照特定命名规则标注表情包](./2021-05-01-huawei-chinesebqb-1619851616000.assets/1619851693154aykSpAZ2.png)


生成的json数据，可作为表情包工具的前端数据库，查询速度极快，无需网络交互~

![生成的json数据](./2021-05-01-huawei-chinesebqb-1619851616000.assets/1619851693547cnRPCJQM.png)

数量统计与文件夹同名的超链接

![数量统计与文件夹同名的超链接](./2021-05-01-huawei-chinesebqb-1619851616000.assets/16198516938747ap7j1kK.png)

自动生成的网页

![自动生成的网页](./2021-05-01-huawei-chinesebqb-1619851616000.assets/1619851693908jhfw55mh.png)
