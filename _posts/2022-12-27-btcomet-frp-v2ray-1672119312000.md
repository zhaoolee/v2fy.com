...
![上传97kb下载3.6MB](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672212316777QYseW83i.png)

![上传115Kb下载6.9MB](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/16722123629495EcMS0P1.png)
...
![下载](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672119350779pwjRB4PH.png)
...
![修改frpc.ini](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672119351031zjJCytYe.png)
...
```
 .\frpc.exe -c .\frpc.ini
```
![运行成功](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672119350712MP3idkAs.png)
...
![修改字段](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672119350848JRaR5bNw.png)
...
```
![测试正常](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672119351028JEsAeAeN.png)
...
![image-20221229155727022](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672300647931aDnArGHf.png)参考资料：https://github.com/233boy/v2ray/tree/master
...
![运行](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672119351184MHfJFmpf.png)

- 添加配置

![添加配置](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672119351275Pps0ssXX.png)

![确定](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672119351487sJ43DEDe.png)

![配置成功](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672119351563CYMTtT3F.png)

如果采用方案2搭建服务端，在服务端直接输入 `v2ray  url`, 即可获得配置字符秘钥, 复制后直接导入即可

![导入](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672300943798Y2FYtdk5.png)



- 如果你下载的BT种子，资源在境外，可以选择全局代理，让服务端转发所有流量，提升下载速度

  ![image-20221229160515112](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672301115872J3NAfK7n.png)

## 安装配置比特彗星

- 首先保证frp 和 v2ray客户端正常运行

![运行](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672119351771GMw526HY.png)
...
![配置51418端口](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672119352306NcReJ3y2.png)

- 为比特彗星配置代理

![配置代理](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672119352702THBpErw0.png)

- 成功 

![成功](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/16721193532403GKbGAb0.png)
...
![优化](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672210489781WKnPA3mn.png)
...
![最终效果](./2022-12-27-btcomet-frp-v2ray-1672119312000.assets/1672211245780KZK76xSN.gif)
