...
![](./2025-09-20-14-28-20-claude-code.assets/1760229687990WzXG5WhK.png)
...
![image-20251012090343385](./2025-09-20-14-28-20-claude-code.assets/1760231028673RYa5mamN.png)
...
![img_v3_02q9_fcedc4ca-f52a-4749-b85d-22cde10c931g](./2025-09-20-14-28-20-claude-code.assets/1758352383324mpxedrbQ.jpeg)
...
![image-20250920150211089](./2025-09-20-14-28-20-claude-code.assets/1758351733553NN7CKWFf.png)
...
![image-20250920150325808](./2025-09-20-14-28-20-claude-code.assets/175835180740671Y5iB60.png)

使用推荐配置，比如使用 shift+enter 可以换行


![image-20250920150353058](./2025-09-20-14-28-20-claude-code.assets/1758351834807aGYkpE5m.png)
...
![image-20250920150554924](./2025-09-20-14-28-20-claude-code.assets/1758351956514p2Y74jRJ.png)
...
![image-20250920151613266](./2025-09-20-14-28-20-claude-code.assets/1758352578722PYN48kDB.png)

输入/model 回车，可以看到当前使用的免费模型



![image-20250920151708159](./2025-09-20-14-28-20-claude-code.assets/1758352629767pP0fBPtZ.png)
...
![image-20250920152501898](./2025-09-20-14-28-20-claude-code.assets/1758353107556zsdnHi5s.png)

![image-20250920152847234](./2025-09-20-14-28-20-claude-code.assets/17583533347356RwzCnbT.png)

继续安装依赖包

![image-20250920153007337](./2025-09-20-14-28-20-claude-code.assets/175835341224520xt0S0c.png)

我刚刚选了几次无需询问特定的命令，claude 把我的项目习惯纪录到了项目的.claude文件夹里的 settting.local.json 里面

![image-20250920153102461](./2025-09-20-14-28-20-claude-code.assets/17583534670222n7FNhFf.png)

自动改代码，并启动项目

![image-20250920153314368](./2025-09-20-14-28-20-claude-code.assets/1758353600834NPsBpfyP.png)

完成了第一版

![image-20250920153446077](./2025-09-20-14-28-20-claude-code.assets/1758353698503kFF4idWp.png)

### VScode精准定位

但我不满意，于是打开 vscode，用低 token 的方式进行精细化调整（如果你不懂代码，可以继续直接终端对话，让 ai 自己改，虽然也能达到目的，但比较费时间，也比较费钱， token 归根到底是要花钱买的）

![image-20250920153752034](./2025-09-20-14-28-20-claude-code.assets/17583538808421pp2sQDt.png)

如果你不习惯使用vscode终端，可以在任意窗口打开claude，然后完成对vscode的关联，即可自动感知vscode代码选中等逻辑



![](./2025-09-20-14-28-20-claude-code.assets/17602298652130StywPjj.png)



![](./2025-09-20-14-28-20-claude-code.assets/1760229880476JsxKAbGx.png)

截图给大模型，提要求，选中代码，进行精细化调整，这种做法可以平替 cursor

![image-20250920154326179](./2025-09-20-14-28-20-claude-code.assets/1758354207609DK1hTYf6.png)

修改后，如果不满意，我们可以继续贴图，继续调整，直到满意为止

![image-20250920160451026](./2025-09-20-14-28-20-claude-code.assets/17583554943923ENtSmCB.png)

## 5.更进阶的模型分流


![82bf843100854bac8eb7cf29dba674d5~tplv-ry4let6mk6-image](./2025-09-20-14-28-20-claude-code.assets/1758357019691Wd4tZJAw.png)
...
![img_v3_02qj_340b0449-c79d-4c4a-8434-2614b3ac60dg](./2025-09-20-14-28-20-claude-code.assets/1760228664872aM1DcZpS.jpeg)
...
![image](./2025-09-20-14-28-20-claude-code.assets/1760228781641MK6raiBp.png)



查看特定路径项目已经添加的mcp信息, `~/.claude.json`

![](./2025-09-20-14-28-20-claude-code.assets/1760228801904kKFMeRKf.png)
...
![](./2025-09-20-14-28-20-claude-code.assets/1760228839142GhSsMCp4.png)

### 通过MCP读取Apifox接口文档

![](./2025-09-20-14-28-20-claude-code.assets/1760228888397yHJmTzhP.png)



然后claude code就可以看到api文档了，有利于自动编写连调代码

![image-20251012082929272](./2025-09-20-14-28-20-claude-code.assets/1760228970552HeHAZXah.png)
...
![](./2025-09-20-14-28-20-claude-code.assets/1760229088599KBmpbX82.png)
...
![](./2025-09-20-14-28-20-claude-code.assets/17602291600185BHXNp5C.png)



有了subAgent，结对编程不是梦

![image-20251012085957913](./2025-09-20-14-28-20-claude-code.assets/1760230801000R4PriK4s.png)



## 8. 团队编程

![](./2025-09-20-14-28-20-claude-code.assets/1760229241677Wsa0CYBz.png)
...
![](./2025-09-20-14-28-20-claude-code.assets/1760229317525szyC66jm.png)
...
![image (9)](./2025-09-20-14-28-20-claude-code.assets/1760229365717QaSJ4xfz.png)

如何查看当前对话的完整聊天记录？使用`Ctrl+O` 组合键，即可查看历史记录的对话

### 上下文过长导致token消耗速率过快怎么办？

![](./2025-09-20-14-28-20-claude-code.assets/1760229432720pNhkJRJ1.png)
...
![](./2025-09-20-14-28-20-claude-code.assets/1760229458955yWaZmA6E.png)
...
![](./2025-09-20-14-28-20-claude-code.assets/1760229491364rwRxbaim.png)

nomal模式也可以修改文件，但几乎每个修改都需要用户确认，而accept edits on 模式可以批量修改

![](./2025-09-20-14-28-20-claude-code.assets/1760229514505aKhH701h.png)

默认开启plan模式是好习惯，我们可以在配置文件中默认以plan模式启动

![](./2025-09-20-14-28-20-claude-code.assets/1760229540275EbXDP0Ee.png)
...
![](./2025-09-20-14-28-20-claude-code.assets/1760229654397x02DH76W.png)
...
![](./2025-09-20-14-28-20-claude-code.assets/1760229623986tRKDXK43.png)
...
![](./2025-09-20-14-28-20-claude-code.assets/1760230934455zXp0rrR1.png)
...
![](./2025-09-20-14-28-20-claude-code.assets/17602308813158YaFRRjw.png)
