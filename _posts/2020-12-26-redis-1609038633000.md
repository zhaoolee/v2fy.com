...
![Redis存储数据的五种数据结构](./2020-12-26-redis-1609038633000.assets/169424733061688tC4CSz.png)
## 1.基础类型string(最基本)
...
![Redis常用命令总结](./2020-12-26-redis-1609038633000.assets/1694247334477pfKbs73s.png)