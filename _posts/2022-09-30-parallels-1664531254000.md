...
![登录成功](./2022-09-30-parallels-1664531254000.assets/1664531554828tx6bfnMJ.png)
...
ps -ef | grep ssh
```
![ssh服务端安装前](./2022-09-30-parallels-1664531254000.assets/1664531554823mBbGZCdB.png)
...
![安装openssh-server后](./2022-09-30-parallels-1664531254000.assets/1664531554825niynJXdT.png)


## 查看虚拟机IP

![虚拟机IP](./2022-09-30-parallels-1664531254000.assets/1664531554830PxRKsDTx.png)

这里虚拟机IP为 `10.211.55.8`

用户名可通过`whoami` 查看为 `parallels`

![image.png](./2022-09-30-parallels-1664531254000.assets/1664531554816TBem6e8m.png)


## 设置虚拟机保持后台运行

![设置虚拟机保持后台运行](./2022-09-30-parallels-1664531254000.assets/1664531554992r2KCKP4p.png)
...
![通过mac终端登录成功](./2022-09-30-parallels-1664531254000.assets/1664531554962zcQpJyTt.png)
