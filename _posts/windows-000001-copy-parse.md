...
![](./windows-000001-copy-parse.assets/ctrl-insert-shift-insert.png)

右手的**复制/粘贴**有什么用途呢? 众所周知,在Windows终端中,是无法使用`Ctrl+v`快捷键,直接粘贴命令的, 而 `Shift+Insert`就可以直接粘贴命令

![](./windows-000001-copy-parse.assets/qiangjinjiu.gif)

**复制粘贴还有一个历史记录的功能**, 当你遇到一些需要分两次粘贴的网盘链接的时候,粘贴板的历史记录功能就非常好用

![](./windows-000001-copy-parse.assets/windows-v.gif)
...
![](./windows-000001-copy-parse.assets/ctrl-click.gif)
...
![](./windows-000001-copy-parse.assets/name.gif)
